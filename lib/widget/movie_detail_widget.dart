        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              isTopMostMovie
                  ? Padding(
                      padding: getPadding(bottom: 1, top: 2),
                      child: Container(
        ...
        Padding(
          ...
          child: BlocBuilder<TrendingMoviesBloc, TrendingMoviesState>(
            builder: (context, state) {
              if (state.movieStatus == TrendingMovieStatus.loaded) {
              ...
              } else if (state.movieStatus == TrendingMovieStatus.error) {
                return const ErrorPage();
              } else if (state.movieStatus == TrendingMovieStatus.loading) {
                return Center(
